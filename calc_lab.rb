...
total = sum_1.to_i + sum_2.to_i + sum_3.to_i + sum_4.to_i + sum_4.to_i + sum_5.to_i + sum_6.to_i 
 if total <= 10 
   puts "You are highly competitive and self-driven. Your determination and hard work-ethic will take you far in life.".blue
   elsif total <= 14 
    ...
    knowing yourself and your emotions.".blue
  end
end
